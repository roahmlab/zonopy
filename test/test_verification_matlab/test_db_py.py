...
for i in range(N_test):
    ...
    r0_r1_l,pm1, fo1= {},{},{}
    for t in range(n_time_steps):
        r0_r1_l[(0,t)] = rotato[(0,t)]@(rotato[(1,t)]@link_zonos[1])
        pm1[(0,t)] = P[0] + rotato[(0,t)]@P[1]
        fo1[(0,t)] = r0_r1_l[(0,t)] + pm1[(0,t)]
    
    import pdb; pdb.set_trace()

    r0_r1_l = process_dict_pz(r0_r1_l,1,n_time_steps)
    pm1 = process_dict_pz(pm1,1,n_time_steps)
    fo1 = process_dict_pz(fo1,1,n_time_steps)

    savemat(save_path+f'r0_r1_l_py_{i}.mat',r0_r1_l)
    savemat(save_path+f'pm1_py_{i}.mat',pm1)
    savemat(save_path+f'fo1_py_{i}.mat',fo1)
    #import pdb; pdb.set_trace()